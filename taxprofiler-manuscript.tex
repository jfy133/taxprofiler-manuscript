...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{$}\NormalTok{ nextflow run nf{-}core/taxprofiler }\AttributeTok{{-}r}\NormalTok{ 1.1.0 }\DataTypeTok{\textbackslash{}}
\NormalTok{{-}profile singularity,}\OperatorTok{\textless{}}\NormalTok{institute}\OperatorTok{\textgreater{}} \DataTypeTok{\textbackslash{}}
\NormalTok{{-}{-}input }\OperatorTok{\textless{}}\NormalTok{samplesheet.csv}\OperatorTok{\textgreater{}}\NormalTok{ {-}{-}databases }\OperatorTok{\textless{}}\NormalTok{database.csv}\OperatorTok{\textgreater{}} \DataTypeTok{\textbackslash{}}
\NormalTok{{-}{-}perform\_shortread\_qc  }\AttributeTok{{-}{-}shortread\_qc\_minlength}\NormalTok{ 20 }\AttributeTok{{-}{-}preprocessing\_qc\_tool}\NormalTok{ falco }\DataTypeTok{\textbackslash{}}
\NormalTok{{-}{-}run\_host\_removal }\AttributeTok{{-}{-}hostremoval\_reference} \StringTok{\textquotesingle{}host\_genome.fasta\textquotesingle{}} \DataTypeTok{\textbackslash{}}
\NormalTok{{-}{-}run\_kraken2 }\AttributeTok{{-}{-}kraken2\_save\_reads} \DataTypeTok{\textbackslash{}}
\NormalTok{{-}{-}run\_metaphlan3 }\DataTypeTok{\textbackslash{}}
\NormalTok{{-}{-}run\_krona }\DataTypeTok{\textbackslash{}}
\NormalTok{{-}{-}run\_profile\_standardisation }\DataTypeTok{\textbackslash{}}
\end{Highlighting}
\end{Shaded}
...
Table~\ref{tbl-tool-summaries} in Supplementary Data summarises the
category and reference database type for each tool.
