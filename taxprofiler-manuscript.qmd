...
The fixed set of software are controlled through the use of the conda package manager or containers (e.g., Docker, Apptainer [previously known as Singularity]) from the stable Bioconda [@Gruning2018-vr] or BioContainers [@Da_Veiga_Leprevost2017-gl] repositories.
...
<!--# (Moritz): I'm personally against including it in the same pipeline, but that's another discussion xD. -->
